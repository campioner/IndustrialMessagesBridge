...
public class AppointMasterAdapter extends RecyclerView.Adapter {
    private List<AppointMaster>apponitMasterList;

    public AppointMasterAdapter(List<AppointMaster> apponitMasterList) {
        this.apponitMasterList = apponitMasterList;
    }
public class AppointMasterViewHolder extends RecyclerView.ViewHolder{
    ...
    public AppointMasterViewHolder(View itemView) {
        super(itemView);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new AppointMasterViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.appoint_master_item,parent,false));
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        AppointMasterViewHolder appointMasterViewHolder=(AppointMasterViewHolder)holder;
        ...
        appointMasterViewHolder.appoint_master_name.setText(apponitMasterList.get(position).getMasterName());
