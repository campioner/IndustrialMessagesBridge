...
public class Banner1 extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private List<MyBanner> imageViews;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        bannerDefaultImage = (ImageView) view.findViewById(com.youth.banner.R.id.bannerDefaultImage);
        ...
        indicator = (LinearLayout) view.findViewById(com.youth.banner.R.id.circleIndicator);
    ...
    public Banner1 setImages(List<?> imageUrls) {
    ...
    private void setImageList(List<?> imagesUrl) {
        ...
        for (int i = 0; i <= count + 1; i++) {
            MyBanner imageView = new MyBanner(this.context);
           /*if (imageLoader != null) {
                ImageView imageView1 = (ImageView) imageLoader.createImageView(context);
                Bitmap bitmap=((BitmapDrawable)imageView1.getDrawable());
                imageView.invalidate();
            }
            if (imageView == null) {
                imageView = new MyBanner(context);
            }*/
             ...
             *
             * */
            imageView.setSrc(Integer.parseInt(url));
    ...
    private void setScaleType(MyBanner imageView) {
