...
import com.example.administrator.industrialmessagesbridge.fragment.BeAppointMentFragment;
...
public class BeAppointMasterActivity extends BaseActivity implements View.OnClickListener  {
    ...
    private String mTitle[]={"预约中","预约记录"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_appoint_master);
    ...
    public void initMagicIndicator(){
        ...
        BeAppointMentFragment appointMasterFragment1=new BeAppointMentFragment();
        Bundle bundle1=new Bundle();
        bundle1.putInt("appoint_type",0);
        appointMasterFragment1.setArguments(bundle1);
        fragmentList.add(appointMasterFragment1);
        BeAppointMentFragment appointMasterFragment2=new BeAppointMentFragment();
